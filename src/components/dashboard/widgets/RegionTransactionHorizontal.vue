...
const option = computed(() => ({
    ...
    yAxis: {
        type: 'category',
        // boundaryGap: false,
        data: Object.keys(regions.value).reverse(),
        axisTick: {
            show: false,
        ...
        axisPointer: {
            lineStyle: {
                color: Dark.isActive ? getPaletteColor('grey-5') : getPaletteColor('primary'),// Cor desejada
            },
        },
        axisLabel: {
            color: Dark.isActive ? getPaletteColor('grey-5') : getPaletteColor('grey-10'),
    ...
    series: [
        {
            ...
            data: Object.values(regions.value).reverse().map((item: any) => {
